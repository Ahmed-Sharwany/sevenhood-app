...
const styles = StyleSheet.create({
  ...
  uploadText: { color: COLORS.textSecondary, fontSize: 14, fontFamily: 'DMSans_500Medium' },
  uploadSub: { color: COLORS.textTertiary, fontSize: 12, fontFamily: 'DMSans_400Regular' },
  uploadDoneText: { color: COLORS.success, fontSize: 14, fontFamily: 'DMSans_600SemiBold' },
  voiceBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  voiceBtnText: { color: COLORS.textSecondary, fontSize: 14, fontFamily: 'DMSans_500Medium' },
  ...
  scheduleText: { color: COLORS.textSecondary, fontSize: 14, fontFamily: 'DMSans_400Regular' },
  scheduleTextActive: { color: COLORS.primary, fontFamily: 'DMSans_500Medium' },
  ...
  submitText: { color: '#fff', fontSize: 16, fontFamily: 'DMSans_600SemiBold', letterSpacing: 0.3 },
});
