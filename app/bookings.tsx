...
const styles = StyleSheet.create({
  ...
  tabBtnText: { color: COLORS.textSecondary, fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  tabBtnTextActive: { color: '#fff' },
  pad: { padding: 20 },
  emptyWrap: { alignItems: 'center', paddingVertical: 60 },
  emptyIcon: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { color: COLORS.primary, fontSize: 18, fontFamily: 'PlayfairDisplay_600SemiBold', marginBottom: 8 },
  emptySub: { color: COLORS.textTertiary, fontSize: 14, fontFamily: 'Inter_400Regular', textAlign: 'center' },
  amenityCard: {
  ...
  amenityInfo: { flex: 1 },
  amenityName: { color: COLORS.textPrimary, fontSize: 15, fontFamily: 'Inter_600SemiBold', marginBottom: 2 },
  amenityDesc: { color: COLORS.textTertiary, fontSize: 12, fontFamily: 'Inter_400Regular', marginBottom: 4 },
  amenityMeta: { flexDirection: 'row', gap: 4 },
  amenityMetaText: { color: COLORS.textSecondary, fontSize: 11, fontFamily: 'Inter_500Medium' },
  bookBadge: {
    backgroundColor: COLORS.primary, borderRadius: 10,
    paddingHorizontal: 12, paddingVertical: 6,
  },
  bookBadgeText: { color: '#fff', fontSize: 12, fontFamily: 'Inter_600SemiBold' },
  bookingCard: {
    backgroundColor: COLORS.surface, borderRadius: 20,
  ...
  bookingAmenityName: { color: COLORS.textPrimary, fontSize: 15, fontFamily: 'Inter_600SemiBold' },
  statusChip: {
  ...
  bookingDetailText: { color: COLORS.textSecondary, fontSize: 12, fontFamily: 'Inter_400Regular' },
  cancelBtn: {
    marginTop: 8, borderWidth: 1, borderColor: `${COLORS.error}40`,
    borderRadius: 12, paddingVertical: 8, alignItems: 'center',
  },
  cancelBtnText: { color: COLORS.error, fontSize: 13, fontFamily: 'Inter_600SemiBold' },
});
...
const modal = StyleSheet.create({
  ...
  title: { color: COLORS.primary, fontSize: 20, fontFamily: 'PlayfairDisplay_600SemiBold' },
  subtitle: { color: COLORS.textTertiary, fontSize: 13, fontFamily: 'Inter_400Regular', marginTop: 2 },
  closeBtn: {
  ...
  dayLabel: { color: COLORS.textSecondary, fontSize: 11, fontFamily: 'Inter_500Medium' },
  dayLabelActive: { color: '#fff' },
  dayNum: { color: COLORS.textPrimary, fontSize: 18, fontFamily: 'Inter_600SemiBold', marginTop: 2 },
  ...
  slotText: { color: COLORS.textPrimary, fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  slotTextActive: { color: '#fff' },
  slotTextTaken: { color: COLORS.textTertiary },
  takenLabel: { color: COLORS.textTertiary, fontSize: 9, fontFamily: 'Inter_400Regular', marginTop: 1 },
  input: {
